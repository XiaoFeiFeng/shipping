...
define(['angular', 'angularAMD', 'uiRouter', 'blockUI', 'bootstrap', 'ui-bootstrap-tpls', 'angular-sanitize',
    ...
    app.controller('indexCtrl', ['$scope', '$timeout', '$ui', '$request', function ($scope, $timeout, $ui, $request) {
        ...
        function openWindwo(point, merchant) {
            ...
            var name = merchant.name == undefined ? merchant.companyName : merchant.name;
            var sContent =
