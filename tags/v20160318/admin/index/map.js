...
function openWindow() {
    ...
    if (params.tp == "personal") {
        conten = '<div style="width: 350px;" class="col-md-12">'
...
function changeAddress() {
    ...
    $.post('/admin/api/?model=merchant&action=edit&id=' + params.key,
        {
            address: address
        }
        , function (result) {
...
function getInfo() {
    $.get('/admin/api/?model=merchant&action=get_byid&id=' + params.key, function (result) {
