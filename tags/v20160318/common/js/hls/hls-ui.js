...
define(['moment', 'locale', 'datetimepicker'], function () {
    var hlsUiModule = angular.module('hls.ui', [
        ...
        'hls.ui.dialogs', 'hls.ui.include', 'hls.ui.grid', 'hls.ui.upload']);
    ...
    angular.module('hls.ui.upload', [])
        .run(["$templateCache", function ($templateCache) {
            $templateCache.put("template/hls/upload.html",
                ...
                '      <button type="button" ng-if="hlsOption.clean.enable"  ng-show="files.length>0" ng-class="hlsOption.clean.class" ng-click="cleanFile()">' +
                '         <span ng-class="hlsOption.clean.icon" ng-bind="hlsOption.clean.text"></span>' +
                '      </button>' +

                '       <button type="button" ng-show="files.length>0"  ng-class="hlsOption.upload.class" ng-click="uploadFile()">' +
                '          <span ng-class="hlsOption.upload.icon" ng-bind="hlsOption.upload.text"></span>' +
                '       </button>' +

                '       <button type="button" ng-class="hlsOption.brower.class" ng-click="browerFile()">' +
