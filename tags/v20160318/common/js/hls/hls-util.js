        ...
        .factory('$ui', ['$q', '$rootScope', '$location', '$dialogs', '$data', '$stateParams', function ($q, $rootScope, $location, $dialogs, $data, $stateParams) {
            ...
            return {
                ...
                locateLogin: function () {
                    var url = "shipping/user.html?module=" + $stateParams.module + "&action=" + $stateParams.action + "#/user/login";
                    this.locate(url);
                },
                locate404: function () {
                    this.locate("shipping/user.html#/system/404");
                },
                locate500: function () {
                    this.locate("shipping/user.html#/system/500");
                },
