    ...
    angular.module('hls.ui.grid', [])
        .run(["$templateCache", function ($templateCache) {
            $templateCache.put("template/hls/grid.html",
                ...
                "<table ng-if=\"showGrid\" ng-class=\"gridOptions.tableClass\">\n" +
                "<thead>\n" +
                "<tr>\n" +
        ...
        .controller('hlsGridController', ['$scope', '$sce', function ($scope, $sce) {
            ...
            if (!$scope.gridOptions.tableClass) {
                $scope.gridOptions.tableClass = "table table-bordered table-striped table-hover";
            }
            ...
            $scope.cleanSelected = function () {
                if ($scope.gridOptions && $scope.gridOptions.colsChk && $scope.gridOptions.colsChk.data) {
