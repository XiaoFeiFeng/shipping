            ...
            function ($scope, $ui, $validate, $request, $uibModalInstance, modalData) {
                ...
                $scope.submitForm = function () {
                    ...
                    if ($scope.data.operator == "edit") {
                        $request.post('api/?model=channel&action=edit_logistics_channels&id=' + $scope.data.channel._id.$id,
                            data,
                            function (response) {
                                $ui.notify('保存成功！', '提示',
                                    function () {
                        ...
                        $request.post('api/?model=channel&action=add_logistics_channels',
                            data,
                            function (response) {
