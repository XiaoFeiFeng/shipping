...
define([], function () {
    angular.module('yilianIntroModule', [])
        .controller('yilianIntroCtrl', ['$scope', '$ui', '$request', '$state', '$data', function ($scope, $ui, $request, $state, $data) {
            $scope.news = {};
            ...
            $scope.getData = function () {
                $request.get('api/?model=news&action=query_one_news&key=type&value=intro', function (response) {
                    if (response.data) {
