...
define([], function () {
    angular.module('yilianCultureModule', [])
        .controller('yilianCultureCtrl', ['$scope', '$ui', '$request', '$state', '$data', function ($scope, $ui, $request, $state, $data) {
            $scope.news = {};
            ...
            $scope.getData = function () {
                $request.get('api/?model=news&action=query_one_news&key=type&value=culture', function (response) {
                    if (response.data) {
