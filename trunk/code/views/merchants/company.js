...
define(['angular-city'], function () {
        ...
        merchantsIndexModule.controller('merchantsCompanyCtrl', ['$scope', '$state', '$store', '$ui', '$request', '$rootScope',
            function ($scope, $state, $store, $ui, $request, $rootScope) {
