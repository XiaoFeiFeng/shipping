    ...
    angular.module('merchantAuditCompanyModule', [])
        .controller("merchantAuditCompanyCtrl", ['$scope', '$ui', '$validate', '$data', '$request', '$config', '$q',
            function ($scope, $ui, $validate, $data, $request, $config, $q) {
                ...
                $scope.dateFormatting = function (input) {
                    return $data.getDate(input);
                }

                $scope.gridOptions = {
                    data: [],
                    cols: [
                        {FieldName: 'name', DisplayName: '公司名称',},
                        ...
                        {FieldName: 'created_time', DisplayName: '申请日期', Formatter: $scope.dateFormatting},
