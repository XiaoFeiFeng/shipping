 ...
 */
'use strict'
var remoteUrl = 'http://192.168.31.254/';
require.config({
...
define(['angular', 'angularAMD', 'uiRouter', 'blockUI', 'bootstrap', 'ui-bootstrap-tpls', 'angular-sanitize', 'angular-summernote', 'fileinput-lang',
    ...
    app.controller('indexCtrl', ['$scope', '$request', '$store', '$ui', '$data', '$rootScope', 'blockUI',


        function ($scope, $request, $store, $ui, $data, $rootScope, blockUI) {
